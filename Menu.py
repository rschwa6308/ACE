...
def display(screen,buttons):
    ...
    #title
    title_img = title_font.render("ACE", True, grid_color)
    screen.blit(title_img, (832/2-title_img.get_width()/2,640/2-title_img.get_height()/2-200))    #auto center text

    #outline
    pygame.draw.rect(screen, grid_color, pygame.Rect(0,0,832-1,640-1), 4)  #'-1' fixes bottom and right edge alignment
...
def level_screen(screen):
    ...
    def display(screen):
        ...
        screen.blit(title_img, (832/2-title_img.get_width()/2,640/2-title_img.get_height()/2-250))    #auto center text
...
def credits_screen(screen):
    ...
    text_img_0 = credits_font.render("A Weekend Project", True, black)
    ...
    def display(screen):
        ...
        screen.blit(text_img_0,(832/2-text_img_0.get_width()/2,100))
        screen.blit(text_img_1,(832/2-text_img_1.get_width()/2,150))
        screen.blit(text_img_2,(832/2-text_img_2.get_width()/2,200))
